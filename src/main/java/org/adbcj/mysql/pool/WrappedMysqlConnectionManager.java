...
import org.adbcj.mysql.pool.org.apache.commons.pool2.impl.GenericObjectPool;
import org.adbcj.mysql.pool.org.apache.commons.pool2.impl.GenericObjectPoolConfig;
import org.adbcj.support.DefaultDbFuture;

public class WrappedMysqlConnectionManager extends AbstractMySqlConnectionManager {

    private DisposeableMySQLConnectionManager plainMySQLConnectionManager = null;
    ...
    public WrappedMysqlConnectionManager(String host, int port, String username, String password, String schema,
        ...
        this.plainMySQLConnectionManager = new DisposeableMySQLConnectionManager(host,
            port,
            username,
            password,
            schema,
